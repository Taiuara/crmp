          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {proposal.createdAt instanceof Date && !isNaN(proposal.createdAt.getTime()) 
                    ? format(proposal.createdAt, 'dd/MM/yyyy HH:mm', { locale: ptBR })
                    : 'Data inválida'
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {proposal.updatedAt instanceof Date && !isNaN(proposal.updatedAt.getTime()) 
                    ? format(proposal.updatedAt, 'dd/MM/yyyy HH:mm', { locale: ptBR })
                    : 'Data inválida'
                  }
                </p>
              </div>
